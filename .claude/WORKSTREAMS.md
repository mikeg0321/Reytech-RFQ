...
|--------|---------|----------|--------|-------------|---------|
| chore/workstreams-sync | (auto session) | `C:\Users\mikeg\rfq-workstreams-sync` | Active | Doc-only sync to mark #733/#734 as merged + supersede stuck Railway build de7c49af (PR #734 deploy hung 60+ min on buildkit base-image fetch, no log progression after 04:57:04Z). | 2026-05-05 |
