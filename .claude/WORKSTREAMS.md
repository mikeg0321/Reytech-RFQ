...
| feat/route-module-load-gate | (auto session) | `C:\Users\mikeg\Documents\rfq-route-module-load-gate` | Active | DATA_ARCHITECTURE_MAP §1 silos S1+S11: boot warning + hard CI test on disk-vs-`_ROUTE_MODULES` drift; URL-map floor tripwire in golden path. Touches `src/api/dashboard.py`, new `tests/test_route_module_registration.py`, `tests/test_golden_path.py`. | 2026-04-25 |
