...
| fix/pc-name-from-attachment-filename | (auto session) | `C:\Users\mikeg\rfq-pc-name-from-attachment-filename` | Active | Surface #17: PC + RFQ name cascade falls back to attachment filename before AUTO_<hash>. | 2026-05-04 |
