...
def pricecheck_detail(pcid):
    ...
    for idx, item in enumerate(items):
        ...
        items_html += f"""<tr style="{row_opacity}" data-row="{idx}">
         ...
         <td><input type="text" name="uom_{idx}" value="{item.get('uom','ea')}" style="width:35px;background:#0d1117;border:1px solid #30363d;color:#c9d1d9;padding:3px;border-radius:4px;font-size:12px"></td>
         <td><input type="text" name="desc_{idx}" value="{item.get('description','').replace('"','&quot;')}" style="width:100%;background:#0d1117;border:1px solid #30363d;color:#c9d1d9;padding:3px;border-radius:4px;font-size:11px"></td>
    ...
    <style>
     ...
     table{{width:100%;border-collapse:collapse}} th,td{{padding:5px 6px;border:1px solid #30363d;text-align:left;font-size:12px}}
     th{{background:#21262d;font-size:10px;text-transform:uppercase;color:#8b949e;white-space:nowrap}}
     .btn{{padding:8px 16px;border-radius:6px;border:none;cursor:pointer;font-weight:600;text-decoration:none;display:inline-block;margin:4px;font-size:13px}}
     .btn-p{{background:#1f6feb;color:#fff}} .btn-g{{background:#238636;color:#fff}} .btn-o{{background:#da3633;color:#fff}}
     .btn-y{{background:#9e6a03;color:#fff}} .btn-v{{background:#8957e5;color:#fff}} .btn-sm{{padding:5px 12px;font-size:12px}}
     a{{color:#58a6ff}} h1{{margin:0;font-size:22px}} .meta{{color:#8b949e;font-size:13px}}
     .status{{padding:3px 8px;border-radius:4px;font-size:12px;font-weight:600;vertical-align:middle}}
     ...
     .num-in{{width:75px;background:#0d1117;border:1px solid #30363d;color:#c9d1d9;padding:3px 4px;border-radius:4px;text-align:right;font-size:12px}}
     .num-in.sm{{width:45px}}
    ...
    function addRow() {{
     ...
     tr.innerHTML='<td style="text-align:center"><input type="checkbox" name="bid_'+idx+'" checked onchange="toggleBid('+idx+',this)"></td>'
      ...
      +'<td><input type="text" name="uom_'+idx+'" value="ea" style="width:35px;background:#0d1117;border:1px solid #30363d;color:#c9d1d9;padding:3px;border-radius:4px;font-size:12px"></td>'
      +'<td><input type="text" name="desc_'+idx+'" value="" style="width:100%;background:#0d1117;border:1px solid #30363d;color:#c9d1d9;padding:3px;border-radius:4px;font-size:11px" placeholder="Enter description"></td>'
      +'<td>—</td><td>—</td><td>—</td>'
        ...
        try:
            ...
            if 0 <= idx < len(items):
                if field_type in ("price", "cost", "markup"):
                    ...
                    items[idx]["uom"] = str(val) if val else "ea"
