...
def api_diag():
    ...
    try:
        ...
        resp = req.get("https://caleprocure.ca.gov/pages/SCPRSSearch/scprs-search.aspx", timeout=10)
        diag["scprs"]["caleprocure_reachable"] = resp.status_code == 200
        diag["scprs"]["caleprocure_status"] = resp.status_code
    except Exception as e:
        diag["scprs"]["caleprocure_reachable"] = False
        diag["scprs"]["caleprocure_error"] = str(e)
