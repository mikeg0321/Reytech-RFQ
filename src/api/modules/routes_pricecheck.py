...
def _pricecheck_detail_inner(pcid):
    ...
    for idx, item in enumerate(items):
        ...
        items_html += f"""<tr style="{row_opacity}" data-row="{idx}"{_disc_attr}>
         ...
         <td style="min-width:100px"><input type="text" name="itemnum_{idx}" value="{mfg_display}" class="text-in lockable-field" style="width:100%;box-sizing:border-box;text-align:center;font-weight:600;font-size:13px;font-family:'JetBrains Mono',monospace;padding:5px 3px" placeholder="MFG#" onblur="handleMfgInput({idx}, this)"></td>
