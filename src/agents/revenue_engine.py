...
def get_goal_progress() -> dict:
    ...
    try:
        ...
        # Projected annual: extrapolate from days elapsed since
        # Jan 1 of the canonical revenue year (calendar, not fiscal).
        now = datetime.now()
        year_start = datetime.fromisoformat(revenue_year_start(REVENUE_YEAR))
